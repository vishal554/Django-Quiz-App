    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('MCQ', 'Multiple choice'), ('FIB', 'fill in the blanks')], max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='quizapp.question')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quiz_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='quizapp.quiz')),
                ('username', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
